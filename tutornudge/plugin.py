...
hooks.Filters.CONFIG_UNIQUE.add_items(
    [
        ...
        # Prefix your setting names with 'NUDGE_'.
        # For example:
        # ("NUDGE_SECRET_KEY", "{{ 24|random_string }}"),
    ]
)
...
# To run the script from templates/nudge/tasks/myservice/init, add:
# hooks.Filters.COMMANDS_INIT.add_item((
#     "myservice",
#     ("nudge", "tasks", "myservice", "init"),
# ))
...
# To build an image with `tutor images build myimage`, add a Dockerfile to templates/nudge/build/myimage and write:
# hooks.Filters.IMAGES_BUILD.add_item((
#     "myimage",
#     ("plugins", "nudge", "build", "myimage"),
#     "docker.io/myimage:{{ NUDGE_VERSION }}",
#     (),
# )
...
hooks.Filters.ENV_TEMPLATE_ROOTS.add_items(
    ...
    [
        pkg_resources.resource_filename("tutornudge", "templates"),
    ]
)
